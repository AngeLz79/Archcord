# Still in the making, beware of bugs and problems
...
A way less cute Discord client mod
With ArchANGEL, giving you history logs of all sorts of things.
...
-   Profile history data (Beta)
-   Online viewer located: [Here](https://archive.ather1.net/)

### What is ArchANGEL?
ArchANGEL is an Archve Network Gateway Engine that Logs data using community fed data from discord.
This client allows users to append to the archive letting others use that data you collected.

## Installing / Uninstalling

Visit https://archive.ather1.net/download
